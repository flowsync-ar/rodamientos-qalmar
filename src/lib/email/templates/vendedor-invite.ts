...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background-color:#ffffff">
  ...
  <tr><td style="padding:32px">
    ...
    <p style="color:#374151;font-size:15px;line-height:1.6">Te dieron de alta como vendedor en Qalmar SRL. Creá tu contraseña para poder acceder al panel de administración.</p>
  ...
  <tr><td style="border-top:1px solid #e5e7eb;padding:24px 32px">
    <p style="color:#9ca3af;font-size:12px;margin:0;text-align:center">Este correo fue enviado por Qalmar SRL. Si no esperabas esta invitación, podés ignorar este mensaje.</p>
  </td></tr>
</table>
</body></html>`
}
