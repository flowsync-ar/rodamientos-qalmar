...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background-color:#ffffff">
  <tr><td style="padding:32px 32px 0 32px;text-align:center">
    <img src="${logoUrl}" alt="Qalmar SRL" width="180" style="display:block;margin:0 auto" />
  </td></tr>
  <tr><td style="padding:32px">
    ...
    <p style="color:#374151;font-size:15px;line-height:1.6">Gracias por registrarte en Qalmar SRL. Confirmá tu email para activar tu cuenta y poder acceder a tu portal de cliente.</p>
  ...
  <tr><td style="border-top:1px solid #e5e7eb;padding:24px 32px">
    <p style="color:#9ca3af;font-size:12px;margin:0;text-align:center">Este correo fue enviado por Qalmar SRL. Si no creaste esta cuenta, podés ignorar este mensaje.</p>
  </td></tr>
</table>
</body></html>`
}
